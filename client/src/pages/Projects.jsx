...
export default function Projects({ onOpenModal }) {
  ...
  const projects = [
    ...
    {
      id: 6,
      title: 'Multinational Manufacturing Enterprise ERP Cloud Deployment',
      domain: 'erp',
      client: 'Heavy Engineering & Industrial OEM (US & Germany)',
      scale: '28 ERP Functional & Technical Consultants',
      duration: '18 Months (Completed & 24/7 AMS)',
      summary: 'Greenfield migration of 18 global company codes from legacy ERP to SAP S/4HANA Cloud & Salesforce CRM, integrating Central Finance (cFin) and custom Fiori UI5 portals.',
      stack: ['SAP S/4HANA Cloud', 'Salesforce CRM', 'Central Finance (cFin)', 'SAP BTP', 'ABAP on HANA', 'SAP Fiori UI5'],
    ...
    {
      id: 7,
      title: '24/7 Enterprise Application Support (AMS) & Cloud Observability',
      domain: 'tech',
      client: 'Global Logistics & Supply Chain SaaS (North America)',
      scale: '24 Full-Stack L1/L2/L3 Support Engineers',
      duration: 'Ongoing (2+ Years)',
      summary: 'Delivering follow-the-sun 24/7/365 production application maintenance across AWS Kubernetes clusters, ensuring <15-minute response on P1 production incidents.',
      stack: ['Datadog APM', 'AWS EKS', 'PostgreSQL', 'Docker', 'Grafana', 'PagerDuty'],
      results: ['99.98% production uptime sustained', '<12 min average P1 acknowledgment SLA', '54% reduction in recurring defect tickets'],
    },
    {
      id: 8,
      title: 'Autonomous Enterprise Document AI & RAG Agentic Extraction Hub',
      domain: 'tech',
      client: 'Multi-National Commercial Real Estate & Asset Manager',
      scale: '14 AI Engineers & Data Scientists',
      duration: '8 Months',
      summary: 'Built a private enterprise Retrieval-Augmented Generation (RAG) system with OCR parsing to autonomously extract, index, and audit 85,000+ complex commercial leases and deeds.',
      stack: ['Python', 'LangChain', 'Llama-3-70B', 'Milvus Vector DB', 'FastAPI', 'React'],
      results: ['82% reduction in manual document audit hours', '99.4% field extraction precision', 'Air-gapped deployment meeting SOC-2'],
    },
  ];
        ...
        <div className="container-fluid">
          <div style={{ display: 'flex', gap: '0.6rem', flexWrap: 'wrap' }}>
            {[
              ...
              { id: 'tech', label: 'Cloud, Software & AI' },
